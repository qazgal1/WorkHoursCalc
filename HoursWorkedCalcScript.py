...
f = open('2024_APRIL.json', encoding="utf8")
...
for times in workInstanses:
    ...
    totalReport.append({"startTime": start_obj_israel, "endTime": end_obj_israel, "Duration": durationTimeWorked,
                        "pay": getSalaryPrice(start_obj_israel), "totalPay": TotalDayPay})
